...
function createConfigPage(pageId, currentConfig) {
  ...
  return {
    pageId: '1',
    name: 'Bulb color by weather',
    nextPageId: null,
    previousPageId: null,
    complete: true,
    sections: [
      {
        name: 'We pull Weather data from Singapore NEA',
        settings:[{
          id: 'information',
          name: 'Smartthings Automation Example based on 3rd party data',
          description: 'The light\'s color will change based on Weather data retrieved from NEA, as follow:\n\nRed: Thunder\nPurple: Cloudy\nBlue: Shower\nWhite: Clear',
          type: 'PARAGRAPH'
        }]        
      },
      {
        name: 'Singapore Weather Data:',
        settings: [
          {
            id: 'area',
            name: 'Which Area',
